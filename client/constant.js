...
export const letterText = [
  ...
  { text: '比心的话我的心估计比较可爱，因为有你在里面', from: '来自喜茶用户@一只柴扉的情书' },
  ...
  // 20-31 kol音频文案
  { text: '来自诗歌岛用户@流马的情书', from: '----荔枝主播@薄荷微凉-小糖 FM13593倾声演绎' },
  { text: '来自喜茶用户@栖檀w的声音情书', from: '----荔枝主播@男伤音 FM789517倾声演绎' },
  { text: '来自冷兔用户@依赖成罪°的声音情书', from: '荔枝主播@NJ苏木 FM187702倾声演绎' },
  { text: '来自三明治用户@苏婕的声音情书', from: '----荔枝主播@一念.猫叔 FM87913742倾声演绎' },
  { text: '来自开始吧用户@菠萝的声音情书', from: '----荔枝主播@清魄 FM1548108倾声演绎' },
  { text: '来自江小白用户@Doraemon的声音情书', from: '----荔枝主播@南熙 FM34276815倾声演绎' },
  { text: '来自概率论用户@安柔的声音情书', from: '荔枝主播@雷鸣 FM1871514倾声演绎' },
  { text: '来自概率论用户@刺槐少女的声音情书', from: '----荔枝主播@宇薇 FM2794135倾声演绎' },
  { text: '来自江小白用户@小洁几的声音情书', from: '----荔枝主播@雲兮 FM48056459倾声演绎' },
  { text: '来自概率论用户@木林森的声音情书', from: '荔枝主播@背着吉他的蝙蝠女侠 FM18084倾声演绎' },
  { text: '来自字媒体用户@醉卧沙场的声音情书', from: '荔枝主播@鱼骨头 FM64860507倾声演绎' },
  { text: '来自字媒体用户@王曼的声音情书', from: '荔枝主播@阿金姑娘 FM1680635倾声演绎' },
];
