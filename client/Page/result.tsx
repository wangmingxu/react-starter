...
class Result extends PureComponent<IProps, IState> {
  ...
  get likeGender() {
    ...
    return matchType <= criticalVal ? 1 : 2;
  }
  ...
  public share = throttle(
    (type) => {
      ...
      (window as any)._hmt.push(['_trackEvent', '页面', '点击', '分享图片']);
    },
    1500,
    { trailing: false },
  );
  ...
  public shareToCircle = throttle(
    () => {
      (window as any).LizhiJSBridge.call('toAction', {
        action: {
          type: 43,
          id: '2686341451598543445',
        },
      });
      (window as any)._hmt.push(['_trackEvent', '页面', '点击', '跳转声鉴交流圈']);
      // location.href = 'https://vodstation.lizhi.fm/static/station_lite/#/stationDetail?v=20180711&stationId=2686341451598543445&t=2018081410';
    },
    1500,
    { trailing: false },
  );
  ...
  public save = throttle(
    () => {
      ...
      (window as any)._hmt.push(['_trackEvent', '页面', '点击', '保存图片']);
    },
    1500,
    { trailing: false },
  );
  ...
  public remake = () => {
    ...
    (window as any)._hmt.push(['_trackEvent', '页面', '点击', '重新鉴定']);
  };
  ...
  public openVoice = () => {
    ...
    (window as any).LizhiJSBridge.call('toAction', { action });
    (window as any)._hmt.push(['_trackEvent', '按钮', '点击', '打开app声音页']);
  };
  ...
  public navToVoicePage = () => {
    ...
    (window as any)._hmt.push(['_trackEvent', '按钮', '点击', '倾听Ta的心声']);
  };
  ...
  public navToZiya = async () => {
    ...
    (window as any)._hmt.push(['_trackEvent', '按钮', '点击', '跳转吱呀']);
  };
  ...
  public render() {
    ...
    return [
      <div styleName="result-page" key="result-page">
        ...
        <div onClick={this.navToVoicePage} styleName="btn-listen-voice" key="voice" />
        <div styleName="test-fate" key="test-fate">
          <div styleName="tit">探知你们的缘分</div>
          <div styleName="btn" onClick={this.openVoice}>
            <div
            ...
            <div styleName="list">
              {recommendList.map(item => (
                <div
                  ...
                  key={item.liveId}
                  onClick={() => {
                    (window as any)._hmt.push(['_trackEvent', '按钮', '点击', '打开推荐直播']);
                    location.href = `lizhifm://www.lizhi.fm?clientparams=17,${item.liveId},${item.radioId}`;
                  }}
                >
      ...
      <div styleName="operation-bar" key="operation-bar">
        <div styleName="btn-operate remake" onClick={this.remake}>
          重新鉴定
        </div>
